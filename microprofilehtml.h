...
"	Result.Sum = Sum;\n"
"	Result.Max = Max;\n"
"	Result.CallAverage = (Sum / CallCount);\n"
"	Result.FrameAverage = (Sum / FrameCount);\n"
...
"		var Sum = TimerInfo[j].Sum;\n"
"		var Max = TimerInfo[j].Max;\n"
"		var CallAverage = (TimerInfo[j].Sum / TimerInfo[j].CallCount);\n"
"		var FrameAverage = (TimerInfo[j].Sum / FrameCount);\n"
"		var FrameMax = TimerInfo[j].FrameMax;\n"
"		TimerInfo[j].CallCount = CallCount;\n"
"		TimerInfo[j].Sum = Sum;\n"
"		TimerInfo[j].Max = Max ;\n"
"		TimerInfo[j].CallAverage = CallAverage;\n"
...
"			StringArray.push(Group.name);\n"
"			StringArray.push(\"Average\");\n"
"			StringArray.push(Group.average);\n"
"			StringArray.push(\"Max\");\n"
"			StringArray.push(Group.max);\n"
"\n"
"			StringArray.push(\"\");\n"
"			StringArray.push(\"\");\n"
"\n"
...
"			StringArray.push(Timer.CallCount / Frames.length);\n"
"\n"
"			StringArray.push(\"\");\n"
"			StringArray.push(\"\");\n"
"\n"
...
"			StringArray.push(Timer.exclaverage.toFixed(3)+\"ms\"); // does not use detailed frames!\n"
"			String";

const size_t g_MicroProfileHtml_end_0_size = sizeof(g_MicroProfileHtml_end_0);
const char g_MicroProfileHtml_end_1[] =
"Array.push(\"Exclusive Max:\");\n"
"			StringArray.push(Timer.exclmax.toFixed(3)+\"ms\"); // does not use detailed frames!\n"
"\n"
"			StringArray.push(\"\");\n"
"			StringArray.push(\"\");\n"
"\n"
...
"			StringArray.push(Group.average.toFixed(3)+\"ms\"); // does not use detailed frames!\n"
"			StringArray.push(\"Frame Max:\");\n"
"			StringArray.push(Group.max.toFixed(3)+\"ms\"); // does not use detailed frames!\n"
"\n"
