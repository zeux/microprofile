...
"				{\n"
"					OrderArray.push(TimerArray[timerindex]);\n"
"				}\n"
"			}\n"
"		}\n"
"		var KeyFunc = null;\n"
...
"					for(var timerindex in TimerArray)\n"
"					{\n"
"						DrawTimerRow(TimerArray[timerindex], 0);\n"
"						Y += Height;\n"
"					}			\n"
"				}\n"
"			}\n"
...
"	}\n"
"}\n"
"function DrawTextBox(context, tex";
...
"			var FrameDiscard = Frame_.frameend + 33;//if timestamps are more than 33ms after current frame, we";

const size_t g_MicroProfileHtml_end_2_size = sizeof(g_MicroProfileHtml_end_2);
const char g_MicroProfileHtml_end_3[] =
" assume buffer has wrapped.\n"
"			var tt = Frame_.tt[nLog];\n"
"			var ts = Frame_.ts[nLog];\n"
